        ...
        <div class="dash_head_tabs w-100 mt-3 text-center">
          <ul class="nav nav-tabs d-flex border-0" id="myTab" role="tablist">
            <li class="nav-item flex-fill" role="presentation">
              <a class="nav-link active" id="allteam-tab" data-toggle="tab" href="#allleads" role="tab" aria-controls="allleads" aria-selected="true">All Departments</a>
            </li>
            <!-- <li class="nav-item flex-fill" role="presentation">
              <a class="nav-link" id="teama-tab" data-toggle="tab" href="#myleads" role="tab" aria-controls="myleads" aria-selected="false">My leads</a>
            </li>
            <li class="nav-item flex-fill" role="presentation">
              <a class="nav-link" id="teamb-tab" data-toggle="tab" href="#taleads" role="tab" aria-controls="taleads" aria-selected="false">Team A leads</a>
            </li>
            <li class="nav-item flex-fill" role="presentation">
              <a class="nav-link" id="teamc-tab" data-toggle="tab" href="#tbleads" role="tab" aria-controls="tbleads" aria-selected="false">Team B Leads</a>
            </li>
            <li class="nav-item flex-fill" role="presentation">
              <a class="nav-link" id="teamc-tab" data-toggle="tab" href="#tcleads" role="tab" aria-controls="tcleads" aria-selected="false">Team C Leads</a>
            </li> -->
          </ul>
        </div>
      </div>
